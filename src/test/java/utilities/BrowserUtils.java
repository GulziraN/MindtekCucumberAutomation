...
public class BrowserUtils {
     ...
     * Ex:
     * .getRandomEmail() returns use^gh-12jnjbnj-nk2n3@gmail.com
     */
    ...
    /**
     * This method accepts a WebElement and a String value to select an option from a dropdown by value.
     * Ex:
    ...
    /**
     * This method will create a WebDriverWait object and wait for certain text to be present
     * in a WebElement
     * Ex:
    ...
    public static void waitForTextToBePresentInElement(WebElement element, String expectedText) {
        WebDriverWait wait = new WebDriverWait(Driver.gerDriver(), 15);
    ...
    public static void scrollDownBy(Integer numOfPixels){
        JavascriptExecutor jse = ((JavascriptExecutor) Driver.gerDriver());
